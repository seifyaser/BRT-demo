...
class _HomeState extends State<Home> {
                                        ...
                                        Center(
                                          child: SizedBox(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                if (_formKey.currentState!.saveAndValidate() && selectedFromStation !=null && selectedToStation != null) {
  ...
  Future.delayed(Duration(seconds: 2), () {
    Navigator.pushNamed(
      ...
      arguments: tState.tickets, // List<TransactionDetailModel>
    );
  });
}
                                            ...
                                            return CustomTripDetailsCard(
                                              ...
                                              onReserve: () {
                                                if (selectedReserveDate == null) {
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    SnackBar(content: Text('يرجى اختيار تاريخ')),
                                                  );
                                                  return;
                                                }
